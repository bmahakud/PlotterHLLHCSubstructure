...
template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::pTbin1(TChain *tr,classInst& read,string ProcessName,int iEvent){

return true;
}

template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::pTbin2(TChain *tr,classInst& read,string ProcessName,int iEvent){

return true;
}

template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::pTbin3(TChain *tr,classInst& read,string ProcessName,int iEvent){

return true;
}

template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::pTbin4(TChain *tr,classInst& read,string ProcessName,int iEvent){
